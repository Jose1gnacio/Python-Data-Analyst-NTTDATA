...
def insertar_delito():
    ...
    area_comunitaria = input("Área comunitaria: ")
    cuadra = input("Cuadra: ")
    fecha_str = input("Fecha (YYYY-MM-DD HH:MM:SS): ")
    latitud = input("Latitud: ")
    longitud = input("Longitud: ")

    # Convertir la entrada de arrestado a booleano
    arrestado = True if arrestado.lower() == "true" else False
